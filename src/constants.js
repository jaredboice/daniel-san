...
const appConstants = {
    ...
    EVENT_FLOWS_WITHIN_X_PERCENT_OF_VALUE: 'EVENT_FLOWS_WITHIN_X_PERCENT_OF_VALUE',
    NEGATIVE_EVENT_FLOWS_WITHIN_X_PERCENT_OF_VALUE: 'NEGATIVE_EVENT_FLOWS_WITHIN_X_PERCENT_OF_VALUE',
    POSITIVE_EVENT_FLOWS_WITHIN_X_PERCENT_OF_VALUE: 'POSITIVE_EVENT_FLOWS_WITHIN_X_PERCENT_OF_VALUE',
    BALANCE_ENDING_SNAPSHOTS_WITHIN_X_PERCENT_OF_VALUE: 'BALANCE_ENDING_SNAPSHOTS_WITHIN_X_PERCENT_OF_VALUE',
