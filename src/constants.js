...
const appConstants = {
    ...
    DISPLAY_END_BALANCES_GREATER_THAN_MAX_AMOUNT: 'DISPLAY_END_BALANCES_GREATER_THAN_MAX_AMOUNT',
    DISPLAY_END_BALANCES_LESS_THAN_MIN_AMOUNT: 'DISPLAY_END_BALANCES_LESS_THAN_MIN_AMOUNT',
